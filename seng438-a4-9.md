...
3.  Click Search
4.  Should view listings for multiple water bottles
5.  Set min price to $5
6.  Set max price to $15
7.  Checkmark condition to 'New'
8.  Waterbottles from the price range of $5 - $15 that are marked as brand new should be displayed
...
## Maham:
Selenium was an overall positive experience. It was easy to record the tests in a very straighforward nature. The UI was very intuitive and easy to manage; I did not need to watch a tutorial or look up a guide to use it. Having Selenium as a Chrome extension made it so that it was very easily accessible. 
Some of the disadvantages may be that occasionally my laptop's performance rate would drop (become slower) while recording a test case. At one point in time, my laptop froze when replaying a test case. 
